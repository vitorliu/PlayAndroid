 ...
 */
public class HierachyClassfyFirstAdapter extends BaseQuickAdapter<HierachyClassifyResponce, BaseViewHolder> {
    public HierachyClassfyFirstAdapter(int layoutResId, @Nullable List<HierachyClassifyResponce> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, HierachyClassifyResponce item) {
